...
# 数据集导出端点令牌桶限流（iter-56，按 user_id 维度限流）
# - RATE_LIMIT_DATASET_EXPORT_CAPACITY: 桶容量，允许的突发上限
# - RATE_LIMIT_DATASET_EXPORT_REFILL_RATE: 每秒补充的令牌数（长期平均速率上限）
RATE_LIMIT_DATASET_EXPORT_CAPACITY: int = 10
RATE_LIMIT_DATASET_EXPORT_REFILL_RATE: float = 0.5
